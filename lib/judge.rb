...
module ChessJudge
  ...
  def find_diag_check(king_square, white)
  ...
  def find_knight_check(king_square, white)
  ...
  def find_file_rank_check(king_square, white)
  ...
  def check(white)
    ...
    diag_check = find_diag_check(king_square, white)
    knight_check = find_knight_check(king_square, white)
    file_rank_check = find_file_rank_check(king_square, white)
